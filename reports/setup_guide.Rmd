...
You can now see a list of the currently available users in goldfinger using this code (the redact=TRUE argument obscures email addresses because this document is online!):
